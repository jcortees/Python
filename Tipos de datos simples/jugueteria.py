...
def main():
    ...
    num_payasos=int(input("Digita el numero de payasos: \n"))
    num_munecas=int(input("Digite el numero de munecas: \n"))
    payasos=num_payasos*112
    munecas=num_munecas*75
    total_paquete=payasos+munecas
    print("El peso total del paquete es:",total_paquete,"Kg")
